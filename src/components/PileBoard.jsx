...
const PileBoard = () => {
  ...
  if (isLoading) {
    return (
      <div className="grid sm:grid-cols-2 m-[1rem] lg:grid-cols-3 gap-x-[2rem] gap-y-[4rem] mt-10 px-4">
  ...
  return (
    <div className=" lg:mx-[30px] mx-[1rem] md:px-0 dark:bg-black min-h-[50vh] ">
      ...
      {!isPileButtonInView && (
        <button
          onClick={setLinkBoardPanelToggle}
          className="fixed z-[2000] bottom-6 right-6 h-8 w-8 md:w-12 md:h-12 animate-fadeIn transition-all duration-500 ease-in-out transform hover:scale-105"
        >
          <div
